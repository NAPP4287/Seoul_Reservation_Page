...
function NotificationDetail({ setShowDetail }) {
  return (
    <div>
      <CloseWrap>
        <img
      ...
      <div className='contentWrap'>
        <DetailBox>
          ...
          주시기 바랍니다. <br />
          ・ 예약 후 당일 방문이 어려울 시 방문일 하루 전까지 취소 부탁드립니다.
          ...
          가능합니다.
          <br />
          ・ 예약시간에 맞춰 입장이 가능하며, 예약 시간 30분 경과 시 예약이 자동
          취소되며, 예약 시간 내에만 입장이 가능합니다.
          ...
          인화성 물질은 반입은 금지되어 있으며, 애완동물 동반이 불가합니다. 바퀴
          달린 신발 및 문화재 공간 훼손 우려가 있는 인라인, 킥보드 등은 입장
          제한될 수 있습니다. <br />
          ・ 아이 동반일 경우 충분한 사전교육을 부탁드리며, 큰소리를 내거나 다른
          방문객의 불편을 초래하지 않도록 보살펴 주시기 바랍니다.
